...
import { Bell, Users, CheckCircle, Clock, TrendingUp, LogOut, Wallet, DollarSign, Award, MessageCircle, Star, ArrowUpRight, Calendar, Sparkles, X } from 'lucide-react';
            ...
            <div className="bg-gradient-to-r from-brand-purple via-brand-magenta to-brand-teal rounded-xl sm:rounded-2xl shadow-2xl p-3 sm:p-5 text-white">
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1 min-w-0 pr-6">
                  ...
                  <p className="text-xs sm:text-sm text-white/90">Successfully logged in. Start earning with referrals!</p>
                </div>
                <button
                  type="button"
